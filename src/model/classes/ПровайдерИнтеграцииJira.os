...
Процедура ПриСозданииОбъекта(Параметры = Неопределено)
	...
	Если Параметры <> Неопределено Тогда
		...
		КлючПроекта(Параметры["project-key"]);
		ИдТипаЗадачи(Параметры["issuetype-id"]);
		ТемаЗадачи(Параметры["summary"]);
	КонецЕсли;
...
//  ПровайдерИнтеграцииJira - текущий объект (цепочка вызовов).
